...
<?php the_post(); ?>			
				...
				<h1 class="page-title"><?php _e( 'Tag Archives:', 'wandrak-02' ) ?> <span><?php single_tag_title() ?></span></h1>
...
<?php if ( $tag_ur_it = tag_ur_it(', ') ) : // Returns tags other than the one queried ?>						
						<span class="tag-links"><?php printf( __( 'Also tagged %s', 'wandrak-02' ), $tag_ur_it ) ?></span>
<?php endif; ?>						
