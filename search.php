...
<?php if ( have_posts() ) : ?>
				...
				<h1 class="page-title"><?php _e( 'Search Results for: ', 'wandrak-02' ); ?><span><?php the_search_query(); ?></span></h1>
...
<?php if ( $post->post_type == 'post' ) { ?>									
					<div class="entry-meta">
						<span class="meta-prep meta-prep-author"><?php _e('By ', 'wandrak-02'); ?></span>
						...
						<span class="meta-prep meta-prep-entry-date"><?php _e('Published ', 'wandrak-02'); ?></span>
...
<?php if ( $post->post_type == 'post' ) { ?>									
					<div class="entry-utility">
						<span class="cat-links"><span class="entry-utility-prep entry-utility-prep-cat-links"><?php _e( 'Posted in ', 'wandrak-02' ); ?></span><?php echo get_the_category_list(', '); ?></span>
						<span class="meta-sep"> | </span>
...
<?php else : ?>
				...
				<div id="post-0" class="post no-results not-found">
					<h2 class="entry-title"><?php _e( 'Nothing Found', 'wandrak-02' ) ?></h2>
					<div class="entry-content">
						<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'wandrak-02' ); ?></p>
	<?php get_search_form(); ?>						
					</div><!-- .entry-content -->
				</div>
