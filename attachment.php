...
<?php the_post(); ?>
				...
				<h1 class="page-title"><a href="<?php echo get_permalink($post->post_parent) ?>" title="<?php printf( __( 'Return to %s', 'wandrak-02' ), wp_specialchars( get_the_title($post->post_parent), 1 ) ) ?>" rev="attachment"><span class="meta-nav">&laquo; </span><?php echo get_the_title($post->post_parent) ?></a></h1>
...
<?php the_content( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'wandrak-02' )  ); ?>
